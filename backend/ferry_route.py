...
def phases():
    ...
    paths = [
        (1, [(940.166,-525.301), (842.677,-477.719), (662.628,-393.373),
             ...
             (319,-187.35), (319,13,PORT_PAUSE), (319,320), (550,400),
        ...
        (24, [(-1354.36,178.488), (-1135.52,173.545), (-765.103,136.485),
              (-650,300), (-540,420), (-443,420), (-443,95.96875,PORT_PAUSE),
              # Leave the pier southwest, then turn west in open water. The
              # old straight leg to (-443,-220) intersected the rocky shore;
              # the device lost deck attachment at (-424.711,-214.898).
              (-500,-40), (-700,-80), (-1055.88,-80),
              (-1219.9,0), (-1354.36,178.488)]),
