...
- [DXVK2.5.3 dynamic-buffer mapping behavior](https://github.com/doitsujin/dxvk/blob/v2.5.3/src/d3d9/d3d9_common_buffer.cpp) and [lock/upload/draw implementation](https://github.com/doitsujin/dxvk/blob/v2.5.3/src/d3d9/d3d9_device.cpp).

Version0.4.3/code20; no runtime image, signing identity, app ID, imported assets or prefix change. Publication and Thor acceptance remain pending at implementation time.
