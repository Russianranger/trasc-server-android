...
- APK/UI/database gates passed for `7641d28e6196a77ffad3b4ff28f8465fb76ba59a`: https://github.com/Russianranger/trasc-server-android/actions/runs/34799675523 . Local checks include 36 Python tests, JVM archive/input/prefix-preservation checks, JS syntax and whitespace. Final refinements disable duplicate launch controls and require a terminating loader error before treating optional missing dependencies as fatal. Main publication will run all gates on the final code. Target APK 0.3.1 / version code 7, preserved signing certificate; record publication commit/run/checksums here.
