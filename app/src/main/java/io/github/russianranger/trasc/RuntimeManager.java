...
public final class RuntimeManager {
    ...
    synchronized void start() throws Exception {
        ...
        for(String name:new String[]{"engine.py","spire.py","spire_catalog.py","log_retention.py","rule_catalog.py","managed_content.py","client_display.py","client_settings.py","client_spells.py","client_addons.py","client_dll.py","client_mouse.py","eq_camera_mouse.h","eq_client_loading.h","eq_fast_decimal.h","eq_spell_checksum.h","eq_display_loading.h","eq_first_person_particles.h","player_data.py","player_tables.py","client_compile_runner.py"})
