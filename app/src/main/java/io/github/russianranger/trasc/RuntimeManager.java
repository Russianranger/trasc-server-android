...
public final class RuntimeManager {
    ...
    synchronized void start() throws Exception {
        ...
        for(String name:new String[]{"engine.py","rule_catalog.py","managed_content.py","client_display.py","client_spells.py","client_addons.py","client_dll.py","player_data.py","player_tables.py"})
