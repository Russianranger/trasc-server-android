...
final class ControllerDialog {
    ...
    void show(){
        ...
        Spinner preset=spinner(Arrays.asList("Thor defaults / cycling","EQ adventure / hotbars (previous)","EQ spell gems (previous)","EQ inventory / cursor (previous)","Original bindings"));
