...
async function clientRuntimeState(){
 ...
 if(!launchOptionsLoaded){
  ...
  for(const [id,key] of [['client-mouse-warp','mouse_warp'],['client-dxvk-hud','dxvk_hud'],['client-sound-diagnostics','sound_diagnostics'],['client-audio','audio'],['client-fullscreen','fullscreen'],['client-native-dll','native_dinput8'],['client-native-models','native_d3dx'],['client-diagnostics','diagnostic_logging']])if(typeof saved[key]==='boolean')$(id).checked=saved[key];
 }
